...
# Using QField survey
In the last sections, you learned about [ForestPlots](ForestPlots.net), installed [QGIS](https://qgis.org/) on your computer and [QField](https://qfield.org/) on your field tablet. It is now time to learn how to collect data in the field using QField. 
...
**12.** Click on the pencil symbol in the top-right corner, you can start typing in data!
